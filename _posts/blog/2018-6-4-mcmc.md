...
## Monte Carlo
Simply put, the Monte Carlo method is to estimate expected values by using samples, it were central to the simulations required for the Manhattan Project during the war.
