...
### Gibbs Sampling
For sample high dimensional distributions, sampling from it's one dimensional conditional distribution is easy, the Gibbs sampling method makes use of this property by sampling iteratively over each dimension.
