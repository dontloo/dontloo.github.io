...
Clearly, an ergodic Markov chain can have only one limiting distribution
...
### Ergodicity
A sufficient condition of having a limiting distribution is ergodicity. The definition of ergodicity are somewhat less intuitive, we only give some sketches here.
