...
The first behaviour to check is the sample average converges to the expectation w.r.t. the stationary distribution as \\(n\to\infty\\)
...
For more details you can refer to [this tutorial by Karl Sigman](http://www.columbia.edu/~ks20/stochastic-I/stochastic-I-MCII.pdf).
