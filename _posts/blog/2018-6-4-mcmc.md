...
### Gibbs Sampling
For sample high dimensional distributions, sampling from it's one dimensional conditional distribution is easy, the Gibbs sampling method makes use of this property to construct the desired Markov chain.

Suppose we have a three dimensional distribution \\(p(x_1, x_2, x_3\\)
