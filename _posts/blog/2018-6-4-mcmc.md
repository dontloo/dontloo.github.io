...
### Irreduciblily
If the entire state space forms one closed communicating class, then the chain is called irreducible. It's the type of chains that we are often interested in, since it's easy to construct one and has a unique stationary distribution.
...
### Irreduciblily
If all states of a Markov chain is a closed communicating class, then the chain is called irreducible. It's the type of chains that we 
