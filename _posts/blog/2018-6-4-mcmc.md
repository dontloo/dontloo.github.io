...
For more about limiting distribution for a Markov chains you can refer to [this tutorial by Karl Sigman](http://www.columbia.edu/~ks20/stochastic-I/stochastic-I-MCII.pdf), also some discussions [here](https://math.stackexchange.com/questions/2812442/what-is-the-necessary-and-sufficient-condition-of-a-markov-chain-having-a-limiti) and [here](https://math.stackexchange.com/questions/2816677/what-is-the-necessary-and-sufficient-condition-of-markov-chain-sample-average-co).
...
A related by slightly different task is to generate samples from a given distribution, which is called sampling. If we can do sampling then we are able to estimate the expectation for sure, but in some cases we can estimate the expectation without the need for precise sampling.
