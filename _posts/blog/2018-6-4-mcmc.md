...
### Ergodicity
If a the limiting distribution exists for a Markov chain, then it is called ergodic. The definition of ergodicity is somewhat less intuitive, we only give some sketches here.
