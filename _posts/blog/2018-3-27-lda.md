...
The training procedure (convergence/burn-in of Markov chains) can be thought of as minimizing the KL divergence between the current distribution and the equilibrium via the transition operator  
