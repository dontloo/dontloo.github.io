...
## Sum of normally/uniformly distributed random variables
The \\( \sqrt{n} \\) scaling factor also applies when summing a finite number of normally/uniformly distributed random variables with the same variance. As described in Wikipedia [here](https://en.wikipedia.org/wiki/Sum_of_normally_distributed_random_variables), and [here](https://en.wikipedia.org/wiki/Irwin%E2%80%93Hall_distribution).
